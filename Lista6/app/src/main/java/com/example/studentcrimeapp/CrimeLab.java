...
public class CrimeLab {
    ...
    public void updateCrime(UUID id, String title, boolean solve, String date, String img_path){
       /* for(Crime crime : mCrimes){
            if(crime.getId().equals(id)){
    ...
    private ContentValues getContetntValues(Crime crime){
        ...
        contentValues.put("image_path",crime.getImg_Path());
